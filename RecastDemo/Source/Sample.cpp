...
void Sample::handleHierarchySettings()
{
	imguiLabel("Hierarchical Subdivision");
	imguiSlider("Max level", &m_max_levels, 0.0f, 10.0f, 1.0f);
	imguiSlider("Level", &m_level, 0.0f, m_max_levels-1, 1.0f);
	imguiSlider("Num merged polys", &m_merged_polys, 2.0f, 20.0f, 1.0f);
