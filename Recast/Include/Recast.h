...
enum rcTimerLabel
{
	...
	/// The time to build the polygon mesh detail. (See: #rcBuildPolyMeshDetail)
	RC_TIMER_BUILD_HIERARCHICAL_GRAPH,
	RC_TIMER_GET_PARENT_NODES,
	RC_TIMER_LINK_START_END_NODES,
	RC_TIMER_FIND_HIERACHICAL_PATH,
	RC_TIMER_GET_SUBPATH,
	RC_TIMER_DELETE_START_END_NODES,
